        ...
        variants: [
            ...
            'variant' => [
                ...
                'secondary' => [
                    ...
                    "[a]:hover:bg-neutral-800/10",
                    "dark:bg-white/10 dark:text-white",
                    "dark:[a]:hover:bg-white/20",
                ],
                'outline' => [
                ...
                'danger' => [
                    ...
                    "dark:bg-red-600/20 dark:focus-visible:ring-red-600/40",
                ],
                'info' => [
                    "bg-blue-600/10 text-blue-600",
                    "focus-visible:ring-blue-600/20",
                    "[a]:hover:bg-blue-600/20",
                    "dark:bg-blue-600/20 dark:focus-visible:ring-blue-600/40",
                ],
                'success' => [
                    "bg-green-600/10 text-green-600",
                    "focus-visible:ring-green-600/20",
                    "[a]:hover:bg-green-600/20",
                    "dark:bg-green-600/20 dark:focus-visible:ring-green-600/40",
                ],
                'warning' => [
                    "bg-amber-600/10 text-amber-600",
                    "focus-visible:ring-amber-600/20",
                    "[a]:hover:bg-amber-600/20",
                    "dark:bg-amber-600/20 dark:focus-visible:ring-amber-600/40",
                ],
            ],
        ],
    ),
